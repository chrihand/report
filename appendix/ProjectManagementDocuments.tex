% Project Management Documents appendix
\chapter{Project Management Documents}
\settocdepth{chapter}
\section{Group Contract}
\label{group_contract}
\includepdf[scale=0.9, pages=1]{fig/GroupContract.pdf}


\includepdf[scale=0.9, pages=2]{fig/GroupContract.pdf}

\section{Customer Contract}
\label{customer_contract}
\includepdf[scale=0.9]{fig/CustomerContract.pdf}
