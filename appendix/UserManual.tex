...
\begin{center}
  \makebox[\textwidth]{\includegraphics[height=80mm, width=\paperwidth-15mm]{appendix/manualPictures/A-newUser-cut.png}}
\end{center}
\begin{enumerate}[nosep]
...
\subsection{Modal}
\begin{center}
  \makebox[\textwidth]{\includegraphics[height=130mm,width=\paperwidth-15mm]{appendix/manualPictures/A-modal-cut.png}}
\end{center}
\begin{enumerate}[nosep]
...
\begin{center}
  \makebox[\textwidth]{\includegraphics[height=80mm, width=\paperwidth-15mm]{appendix/manualPictures/A-providers-cut.png}}
\end{center}
\begin{enumerate}[nosep]
...
\begin{center}
  \makebox[\textwidth]{\includegraphics[height=80mm, width=\paperwidth-15mm]{appendix/manualPictures/A-activities-cut.png}}
\end{center}
\begin{enumerate}[nosep]
    \item Knapp for å tømme og tilbakestille søke valg (punkter 2,3 og 4)
...
\subsection{Forside}
\begin{center}
  \makebox[\textwidth]{\includegraphics[height=110mm, width=\paperwidth-15mm]{appendix/manualPictures/S-home-cut.png}}
\end{center}
\begin{enumerate}[nosep]
...
\subsection{Modal}
\begin{center}
  \makebox[\textwidth]{\includegraphics[height=130mm, width=\paperwidth-15mm]{appendix/manualPictures/S-modal-loggedIn-cut.png}}
\end{center}
...
\subsection{Arrangører}
\begin{center}
  \makebox[\textwidth]{\includegraphics[height=80mm, width=\paperwidth-15mm]{appendix/manualPictures/S-providers-cut.png}}
\end{center}
\begin{enumerate}[nosep]
...
\begin{center}
  \makebox[\textwidth]{\includegraphics[height=80mm, width=\paperwidth-15mm]{appendix/manualPictures/S-addNewSubProfile-cut.png}}
\end{center}
\begin{enumerate}[nosep]
...
\begin{center}
  \makebox[\textwidth]{\includegraphics[height=80mm, width=\paperwidth-15mm]{appendix/manualPictures/S-changeUser-cut.png}}
\end{center}
\begin{enumerate}[nosep]
...
\begin{center}
  \makebox[\textwidth]{\includegraphics[height=80mm, width=\paperwidth-15mm]{appendix/manualPictures/S-addProvider-cut.png}}
\end{center}
\begin{enumerate}[nosep]
...
\begin{center}
  \makebox[\textwidth]{\includegraphics[height=80mm, width=\paperwidth-15mm]{appendix/manualPictures/S-Facebook-login-cut.png}}
\end{center}
...
\subsection{Min Side}
\begin{center}
  \makebox[\textwidth]{\includegraphics[height=80mm, width=\paperwidth-15mm]{appendix/manualPictures/S-myPage-Provider-cut.png}}
\end{center}
\begin{enumerate}
...
\begin{center}
  \makebox[\textwidth]{\includegraphics[height=80mm, width=\paperwidth-15mm]{appendix/manualPictures/S-newActivity-blank-cut.png}}
\end{center}
\begin{enumerate}[nosep]
...
\begin{center}
  \makebox[\textwidth]{\includegraphics[height=80mm, width=\paperwidth-15mm]{appendix/manualPictures/S-Provider-page-cut.png}}
\end{center}
\begin{enumerate}
